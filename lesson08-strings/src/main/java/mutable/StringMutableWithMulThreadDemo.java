...
public class StringMutableWithMulThreadDemo implements Runnable{
	...
	public void addChar() {
		/*
		 * Here appended 6 A and removed 5 A at each call to this method. Total 1 A at
		 * each call Expected Accurate Total StringBuilder length = loops in run method
		 * * 1 i.e. 50000 * 1 for one thread Here we have 2 threads so = 100000
		 */
	...
	public static void main(String[] args) {
		...
		// main thread
		System.out.println("Final String Mutable Length: "
				+ NumberFormat.getNumberInstance().format(process.stringMutable.length()));
