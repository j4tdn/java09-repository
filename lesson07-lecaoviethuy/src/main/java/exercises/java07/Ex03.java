...
public class Ex03 {
	public static void main(String[] args) {
		...
		System.out.println("It is day number " + c.get(DAY_OF_YEAR)
					+ " of the year, " + (c.getActualMaximum(DAY_OF_YEAR) - c.get(DAY_OF_YEAR)) + " days left");
		...
		System.out.println("It is " + dayOfWeek[dow - 1] 
				+ " number " + (differenceWeeks + 1) 
				+ " out of " + (totalDifferenceWeeks + 1) 
				+ " in " + c.get(YEAR));
		...
		System.out.println("It is " + dayOfWeek[dow - 1] 
				+ " number " + (differenceWeeks + 1)
				+ " out of " + (totalDifferenceWeeks + 1)
				+ " in month " + (c.get(MONTH) + 1));
		
		System.out.println("Year " + c.get(YEAR) + " has " + c.getActualMaximum(DAY_OF_YEAR) + " days");
		
		System.out.println("Month " + (c.get(MONTH) + 1) + ", " + c.get(YEAR)
						+ " has " + c.getActualMaximum(DAY_OF_MONTH) + " days");
	}
