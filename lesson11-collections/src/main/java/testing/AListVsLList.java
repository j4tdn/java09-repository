...
public class AListVsLList {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < COUNT; i++) {
			alist.add(5, "element # " + i);
		}
		System.out.println("Add at index 5: " + COUNT + " elements: ArrayList took "
				+ (System.currentTimeMillis() - start) + "ms");

		start = System.currentTimeMillis();
		for (int i = 0; i < COUNT; i++) {
			llist.add(5, "element # " + i);
		}
		System.out.println("Add at index 5: " + COUNT + " elements: LinkedList took "
				+ (System.currentTimeMillis() - start) + "ms");
