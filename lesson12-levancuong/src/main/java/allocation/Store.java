...
//                .isEquals();
	...
	public String toString() {
		return new ToStringBuilder(this).append("storeId", storeId).append("referenceStoreId", referenceStoreId)
				.append("storePreviousDay", storePreviousDay).append("expectedSales", expectedSales)
