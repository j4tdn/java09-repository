...
public class ItemGroupDto {
	...
	public boolean equals(Object o) {
		...
		return new EqualsBuilder().append(getIgrId(), that.getIgrId()).append(getIgrName(), that.getIgrName())
				.append(getItemList(), that.getItemList()).append(getTotalOfItems(), that.getTotalOfItems()).isEquals();
	}

	@Override
	public int hashCode() {

		return new HashCodeBuilder().append(getIgrId()).append(getIgrName()).append(getItemList())
				.append(getTotalOfItems()).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append(getIgrId()).append(getIgrName())
				.append(getItemList()).append(getTotalOfItems()).build();
	}
}
