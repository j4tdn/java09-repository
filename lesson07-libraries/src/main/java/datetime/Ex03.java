...
public class Ex03 {
	public static void main(String[] args) {
		...
		long remainingMinute = remainingHours - TimeUnit.HOURS.toMillis(hours);
		long minute = TimeUnit.MILLISECONDS.toMinutes(remainingMinute);

		long remainingSeconds = remainingMinute - TimeUnit.MINUTES.toMillis(minute);
		long second = TimeUnit.MILLISECONDS.toSeconds(remainingSeconds);
